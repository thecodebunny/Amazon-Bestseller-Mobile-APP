...
namespace Thecodebunny\PWA\Http\Resources\Checkout;
...
class CartItem extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'price' => $this->price,
            'formated_price' => core()->currency($this->base_price),
