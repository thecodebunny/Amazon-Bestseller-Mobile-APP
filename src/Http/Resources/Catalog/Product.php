...
namespace Thecodebunny\PWA\Http\Resources\Catalog;

use Illuminate\Http\Resources\Json\JsonResource;
use Thecodebunny\API\Http\Resources\Catalog\ProductImage;
...
class Product extends JsonResource
{
    ...
    {
        $this->productPriceHelper = app('Thecodebunny\PWA\Helpers\Price');

        $this->productReviewHelper = app('Thecodebunny\Product\Helpers\Review');
    ...
    public function toArray($request)
    {
        ...
        switch ($product->type) {
            ...
            case 'bundle':
                ...
                $data['bundle_options'] = app('Thecodebunny\Product\Helpers\BundleOption')->getBundleConfig($product);
            break;

            case 'booking':
                $bookingProduct = app('\Thecodebunny\BookingProduct\Repositories\BookingProductRepository')->findOneByField('product_id', $product->product_id);
                ...
                if ($data['booking_product']->type == "appointment") {
                    $bookingSlotHelper = app('\Thecodebunny\BookingProduct\Helpers\AppointmentSlot');
                ...
                if ($data['booking_product']->type == "event") {
                    $bookingSlotHelper = app('\Thecodebunny\BookingProduct\Helpers\EventTicket');
                ...
                if ($data['booking_product']->type == "table") {
                    $bookingSlotHelper = app('\Thecodebunny\BookingProduct\Helpers\TableSlot');
