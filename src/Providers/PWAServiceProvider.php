...
use Thecodebunny\Checkout\Facades\Cart as CartFacade;
...
class PWAServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__ . '/../../publishable/assets'   => public_path('vendor/thecodebunny/pwa/assets'),
        ], 'public');
    }
    ...
    protected function registerFacades()
    {
        ...
        $this->app->bind('cart', 'Thecodebunny\PWA\Cart');
    }
}
