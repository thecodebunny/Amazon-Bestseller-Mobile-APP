...
var version = 'v3.0';
var staticCache = 'thecodebunny-pwa-static-' + version;
var serverCache = 'thecodebunny-pwa-server-' + version;
var outSideCache = 'thecodebunny-pwa-outside-' + version;
        ...
        if (checkResponse == true) {
            return fetch(request).then(function(networkResponse) {
                ...
                return cache.match(storageUrl).then(function(response) {
                    if (response) return formFilter(response);
                    else return fallBackResponse('live');
                });
            });
        } else {
            return cache.match(storageUrl).then(function(response) {
